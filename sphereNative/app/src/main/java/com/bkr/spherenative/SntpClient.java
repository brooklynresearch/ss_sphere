 ...
 *
 * Modified by Rômulo Fernandes (romulo@hub9.co)
 */
...
public class SntpClient {
    ...
    // stores local clock offset compared to NTP server
    ...
    public boolean requestTime(String host, int timeout) {
        ...
        try {
            ...
            // if (false) Log.d(TAG, "clock offset: " + mClockOffset + " ms");
    ...
    /**
     * Returns local clock offset compared to NTP server
     *
